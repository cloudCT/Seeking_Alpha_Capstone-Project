...
```{r , eval = T, class.source = "fold-hide", message =F, warning= F, error =F, include = T, echo = T, results ="hold"}
...
```{r google chart,eval = T, class.source = "fold-hide", message =F, warning= F, error =F, include = T, echo =F,results="hide" }
...
```{r aapl chart,eval = T, class.source = "fold-hide", message =F, warning= F, error =F, include = T, echo =F,results ="hide"}
getSymbols("AAPL")
chartSeries(AAPL,
            subset = "last 11 years",
            type = "line",
